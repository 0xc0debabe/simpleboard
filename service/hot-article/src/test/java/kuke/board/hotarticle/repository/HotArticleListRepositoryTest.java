...
class HotArticleListRepositoryTest {
    ...
    void addTest() throws InterruptedException {
        LocalDateTime time = LocalDateTime.of(2025, 9, 6, 0, 0);
        long limit = 3;
        ...
        List<Long> articleIds = hotArticleListRepository.readAll("20250906");
        ...
        assertThat(hotArticleListRepository.readAll("20250906")).isEmpty();
    }
